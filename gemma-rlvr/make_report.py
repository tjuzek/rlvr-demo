...
<title>Gemma-2-2B RLVR on GSM8K — Hunting the variance band</title>
...
<header class="report-header">
  <div>
    <div class="eyebrow">Experiment 3 · RLVR · GSM8K · Gemma-2-2B</div>
    <h1>Hunting the variance band{f" · {escape(label)}" if label else ""}</h1>
